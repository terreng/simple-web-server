...
lang = {
    "en": {
        ...
        "section_advanced_rules": "Advanced settings",
        "option_ipv6": "Listen on IPV6",
        "option_ipv6_description": "Listen over IPV6 instead of the default, which is IPV4. This will change the web server URL(s) to be IPV6 instead of IPV4, however IPV4 addresses will remain functional when LAN is enabled.",
